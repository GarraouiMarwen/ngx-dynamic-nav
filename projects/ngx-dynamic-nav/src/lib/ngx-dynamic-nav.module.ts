...
import {ThemeConfigService} from './utils/themeConfig.service';

@NgModule({
  declarations: [NgxDynamicNavComponent, FilterPipe],
  imports: [
    CommonModule,
    FontAwesomeModule
  ],
  exports: [NgxDynamicNavComponent]
})
export class NgxDynamicNavModule {
  constructor() {
    library.add(faAd);
  ...
  static forRoot(config: string): ModuleWithProviders {
    return {
      ngModule: NgxDynamicNavModule,
      providers: [
        ThemeConfigService,
        NgxDynamicNavService
      ]
    };
  }
}
